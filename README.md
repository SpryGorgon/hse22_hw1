...
## 9. Основные показатели из ноутбуков
Общее количество контигов: 602

Общая длина контигов: 3'950'602

Длина самого длинного контига: 143'791

Значение N50 для контигов: 299

Общее количество скаффолдов: 68

Общая длина скаффолдов: 3'921'699

Длина самого длинного скаффолда: 3'885'015

Значение N50 для скаффолдов: 1

Количество гэпов в самом длинном скаффолде: 146

Общая длина гэпов в самом длинном скаффолде: 6581

Количество гэпов в самом длинном скаффолде после gap-close: 23

Общая длина гэпов в самом длинном скаффолде после gap-close: 1246
...
Общая длина контигов: было 3'950'602, стало 3'967'154
...
Общая длина скаффолдов: 3'921'699, стало 3'915'033
